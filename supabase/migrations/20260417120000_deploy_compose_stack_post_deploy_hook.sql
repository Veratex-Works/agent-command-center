-- deploy_compose_template: openclaw-post-deploy-hook uses OPENCLAW_STACK_HOOK_IMAGE (packages/openclaw-stack-hook); Hostinger compose content max 8192 chars.
